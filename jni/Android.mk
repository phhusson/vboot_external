...
LOCAL_C_INCLUDES += $(VLIB_HDR) jni/openssl/include/
...
$(LOCAL_PATH)/futility/futility_cmds.c: ${FUTIL_SRCS:%=${LOCAL_PATH}/%}
...
LOCAL_GENERATED_SOURCES := futility/futility_cmds.c

LOCAL_C_INCLUDES += $(VLIB_HDR) jni/openssl/include/
LOCAL_STATIC_LIBRARIES := libvboot_util-host libcrypto-static
LOCAL_FORCE_STATIC_EXECUTABLE := true
LOCAL_LDFLAGS := -static
include $(BUILD_EXECUTABLE)

include $(LOCAL_PATH)/openssl/crypto/Android.mk
